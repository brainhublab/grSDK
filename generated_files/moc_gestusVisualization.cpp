...
struct qt_meta_stringdata_GestusVisualization_t {
    QByteArrayData data[1];
    char stringdata0[20];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_GestusVisualization_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_GestusVisualization_t qt_meta_stringdata_GestusVisualization = {
    {
QT_MOC_LITERAL(0, 0, 19) // "GestusVisualization"
...
const QMetaObject GestusVisualization::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_GestusVisualization.data,
      qt_meta_data_GestusVisualization,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *GestusVisualization::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GestusVisualization.stringdata0))
