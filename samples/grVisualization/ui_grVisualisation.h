...
public:
    ...
    void retranslateUi(QMainWindow *GRVisualization)
    {
        ...
        ___qtreewidgetitem1->setText(0, QApplication::translate("GRVisualization", "Device Name", 0));
        QTreeWidgetItem *___qtreewidgetitem2 = ___qtreewidgetitem1->child(0);
        ___qtreewidgetitem2->setText(0, QApplication::translate("GRVisualization", "ID", 0));
        QTreeWidgetItem *___qtreewidgetitem3 = ___qtreewidgetitem1->child(1);
        ___qtreewidgetitem3->setText(0, QApplication::translate("GRVisualization", "Path", 0));
        ...
        loggingCheckBox->setText(QApplication::translate("GRVisualization", "Logging", 0));
