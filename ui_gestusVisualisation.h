...
public:
    ...
    void setupUi(QMainWindow *GestusVisualization)
    {
        ...
        QTreeWidgetItem *__qtreewidgetitem = new QTreeWidgetItem(devicesTree);
    ...
    {
        GestusVisualization->setWindowTitle(QApplication::translate("GestusVisualization", "GR SDK", 0, QApplication::UnicodeUTF8));
        ...
        ___qtreewidgetitem->setText(0, QApplication::translate("GestusVisualization", "Connected GR Devices", 0, QApplication::UnicodeUTF8));

        const bool __sortingEnabled = devicesTree->isSortingEnabled();
        devicesTree->setSortingEnabled(false);
        QTreeWidgetItem *___qtreewidgetitem1 = devicesTree->topLevelItem(0);
        ___qtreewidgetitem1->setText(0, QApplication::translate("GestusVisualization", "Device Name", 0, QApplication::UnicodeUTF8));
        QTreeWidgetItem *___qtreewidgetitem2 = ___qtreewidgetitem1->child(0);
        ___qtreewidgetitem2->setText(0, QApplication::translate("GestusVisualization", "ID", 0, QApplication::UnicodeUTF8));
        QTreeWidgetItem *___qtreewidgetitem3 = ___qtreewidgetitem1->child(1);
        ___qtreewidgetitem3->setText(0, QApplication::translate("GestusVisualization", "Path", 0, QApplication::UnicodeUTF8));
        devicesTree->setSortingEnabled(__sortingEnabled);

        trajectoryCheckBox->setText(QApplication::translate("GestusVisualization", "Trajectory", 0, QApplication::UnicodeUTF8));
        randomData->setText(QApplication::translate("GestusVisualization", "RandomData", 0, QApplication::UnicodeUTF8));
        rightHandCheckBox->setText(QApplication::translate("GestusVisualization", "Right Hand", 0, QApplication::UnicodeUTF8));
        loggingCheckBox->setText(QApplication::translate("GestusVisualization", "Logging", 0, QApplication::UnicodeUTF8));
        hackerModeCheckBox->setText(QApplication::translate("GestusVisualization", "Hacker Mode", 0, QApplication::UnicodeUTF8));
        leftHandCheckBox->setText(QApplication::translate("GestusVisualization", "Left Hand", 0, QApplication::UnicodeUTF8));
        pausePlotCheckBox->setText(QApplication::translate("GestusVisualization", "Pause Plot", 0, QApplication::UnicodeUTF8));
