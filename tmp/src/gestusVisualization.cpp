#include "gestusVisualisation.h"
#include "ui_mainwindow.h"


GestusVisualisation::GestusVisualisation(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::GestusVisualisation)
{
    ui->setupUi(this);
...
GestusVisualisation::~GestusVisualisation()
{
    delete ui;
}

bool GestusVisualisation::setupPlotters(std::deque<std::string> *acc, std::deque<std::string> *gyro, std::deque<std::string> *mag)
{
