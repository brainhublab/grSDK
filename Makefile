...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Sun Apr 9 13:54:33 2017
...
SOURCES       = src/main.cpp \
		...
		src/grAlgorithm.cpp build/generated_files/moc_grVisualization.cpp \
...
build/grAlgorithm.o: src/grAlgorithm.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/grAlgorithm.o src/grAlgorithm.cpp
